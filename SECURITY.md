...
For how these controls together cover what an automated PR reviewer would catch — and the one accepted residual — see [REVIEW-GATE.md](REVIEW-GATE.md). For how they map onto the OpenSSF Best Practices passing-level criteria, see [OPENSSF-BEST-PRACTICES.md](OPENSSF-BEST-PRACTICES.md).
