...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--: | :--: | :-----------------: | ------------------------------------------------------------------- |
| [Authelia](https://github.com/iderex/jellyfin-plugin-sso/wiki/Provider-Setup#authelia)                                                                                                      |  ✔   |  —   |          ✔          | [planned](https://github.com/iderex/jellyfin-plugin-sso/issues/921) |
| [authentik](https://github.com/iderex/jellyfin-plugin-sso/wiki/Provider-Setup#authentik)                                                                                                    |  ✔   |  —   |          ✔          | [planned](https://github.com/iderex/jellyfin-plugin-sso/issues/920) |
...
| [Pocket ID](https://github.com/iderex/jellyfin-plugin-sso/wiki/Provider-Setup#pocket-id)                                                                                                    |  ✔   |  —   |          ✔          | [planned](https://github.com/iderex/jellyfin-plugin-sso/issues/922) |
| [Kanidm](https://github.com/iderex/jellyfin-plugin-sso/wiki/Provider-Setup#kanidm)                                                                                                          |  ✔   |  —   |          ✔          | [planned](https://github.com/iderex/jellyfin-plugin-sso/issues/923) |
| Google                                                                                                                                                                                      |  ✔   |  —   |          —          | manual (cloud)                                                      |
...
**E2E (CI)** is a live, headless login round-trip against a real Jellyfin + identity-provider stack. "automated" providers run in CI; the full provider matrix ([Zitadel](https://github.com/iderex/jellyfin-plugin-sso/issues/924) and [Dex](https://github.com/iderex/jellyfin-plugin-sso/issues/925) join it too) runs only at a release and a beta-release, while a pull request that touches the harness (and the nightly run) exercises just the one canonical Keycloak harness (tracking: [#919](https://github.com/iderex/jellyfin-plugin-sso/issues/919)). Cloud providers (Google, Entra&nbsp;ID) can't run in ephemeral CI, so they are verified manually and marked "manual".
